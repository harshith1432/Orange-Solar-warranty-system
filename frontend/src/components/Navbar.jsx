        ...
        <div className="flex items-center gap-1.5 sm:gap-3 shrink-0">
          {!loggedIn ? (
            <>
              ...
              <Link
                to="/register"
                className="text-xs font-bold text-white bg-gradient-to-r from-orange-500 to-amber-500 hover:from-orange-600 hover:to-amber-600 px-3 py-1.5 sm:px-4 sm:py-2 rounded-xl shadow-md shadow-orange-500/20 hover:shadow-orange-500/30 flex items-center gap-1 sm:gap-1.5 transition-all whitespace-nowrap"
              >
                <span>Register</span>
